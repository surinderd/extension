...
class AbstractReader
{
    ...
    protected function addListingToolbarSettings()
    {
		...
		$select = $connection->select()
			->from(
				['ce' => 'otta_flags_column']
			);
$flascolumn = $connection->fetchAll($select);
		...
		foreach($flascolumn as $val)
		{
		
		$name = $val['id'].'-'.$val['name'];
		$columnids = 'amasty_ogrid_product_cuflags_'.$name;
		
		$result['item']['productColsData']['item'][$columnids] = array(
                    'name' => $columnids,
                    'xsi:type' => 'array',
                    'item' => array
                        (
...
,
                           'label' => Array
                                (
								 ...
								 'component' =>array('component',
                                    'xsi:type' => 'string',
                                    'value' => 'Otta_OttaVendor/js/grid/columns/flag'
		...
		// print_r($result['item']['productColsData']['item']);
           // die;
